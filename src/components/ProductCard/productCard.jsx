      ...
      return (
        <React.Fragment>
          ...
          <Button 
            ...
            className="update-cart-btn h3 p-text-center p-button-raised p-button-rounded p-pl-4 p-pr-4"
          />
        </React.Fragment>
      );
    }
    return (
      <React.Fragment>
        ...
        <Button
          ...
          className="add-cart-btn h3 p-text-center p-button-raised p-button-rounded p-pl-4 p-pr-4"
        />
      </React.Fragment>
    );
  };
